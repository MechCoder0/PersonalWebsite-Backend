...
AUTH0_DOMAIN = 'dev-fullstack.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'blogosphear'
...
'''
    This attempts to get the header from the request
...
'''
    ...
    it raises an AuthError if permissions are not
